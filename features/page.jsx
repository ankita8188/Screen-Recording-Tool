...
const feature = () => {
  return (
    <>
  {/* Features */}
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-blue-300">
            ...
            >
              <span className="flex gap-x-6">
                ...
                <span className="grow">
                  ...
                  <p>Full-Screen Recording: Capture everything on the screen.</p>
                  <p>Window Recording: Record a specific window or application.</p>
                  <p>Custom Region Recording: Select and record a specific area of the screen.</p>
                  </span>
                </span>
              </span>
            </button>
            ...
            >
              <span className="flex gap-x-6">
                ...
                <span className="grow">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                   <p>System Audio Recording: Capture audio from your computer or device during recording.</p>
                  </span>
                </span>
              </span>
            </button>
            ...
            >
              <span className="flex gap-x-6">
                ...
                <span className="grow">
                  ...
                  <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
                    Reduce time and connect with others
                  </span>
                </span>
              </span>
            </button>
