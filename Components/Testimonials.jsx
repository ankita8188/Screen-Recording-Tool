      ...
      <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
        ...
        <div className="lg:col-span-4">
          ...
          <blockquote>
            ...
            "I’ve tried several screen recording tools, but none have been as affordable and feature-packed as this one. The customizable settings, fast export options, and seamless integration with editing software make it a fantastic choice."
